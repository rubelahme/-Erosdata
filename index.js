...
client.connect((err) => {
  const collection = client.db("ErosUpdate").collection("Update");
  const collections = client.db("ErosUpdate").collection("image");
  const ImageCollection = client.db("ErosUpdate").collection("NewImage");
...
// https://shrouded-beach-70099.herokuapp.com/images
